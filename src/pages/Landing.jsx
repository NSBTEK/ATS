...
import {
  ...
  CheckCircle, ArrowRight, Phone, Mail, Linkedin, Menu, X,
    ...
    <div className="min-h-screen bg-[#050d1a] text-white font-inter">
      ...
      <nav className="fixed top-0 w-full z-50 bg-[#050d1a]/95 backdrop-blur-md border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={() => { window.location.href = '/ATS/dashboard'; }}
        ...
        <div className="relative max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center py-20">
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <button onClick={() => { window.location.href = '/ATS/dashboard'; }}
                className="border-white/20 text-white hover:bg-white/10 px-6 py-3 h-auto rounded-xl text-sm font-semibold gap-2 bg-transparent">
                Platform Login
              </button>
            </div>
            {/* Badges */}
      ...
      <footer className="bg-[#030a14] border-t border-white/5 py-10">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            {['Home', 'About Us', 'Contact Us', 'Blog'].map(l => (
          ...
          <div>
            ...
            {['Cybersecurity', 'Security Operations Center', 'HR Consulting', 'AI Solutions'].map(l => (
              <a key={l} href="#" className="block text-xs text-white/40 hover:text-white/70 mb-2 transition-colors">{l}</a>
            ))}
          </div>
          <div>
            <p className="text-xs font-bold text-white/60 uppercase tracking-wider mb-4">Platform Login</p>
            <button onClick={() => { window.location.href = '/ATS/dashboard'; }} className="block text-xs text-white/40 hover:text-white/70 mb-2 transition-colors">Login to NSBTEK</button>
          </div>
        </div>
